    ...
    public var statusMessage: String {
        ...
        case .notDetermined:
            return NSLocalizedString(
                ...
                value: "Tap to enable sleep reminders",
                comment: ""
            )
        ...
        case .denied:
            return NSLocalizedString(
                ...
                value: "Enable in Settings to receive reminders",
                comment: ""
            )
        ...
        case .provisional:
            return NSLocalizedString(
                ...
                value: "Quiet notifications enabled",
                comment: ""
            )

        case .ephemeral:
            return NSLocalizedString(
                "Notifications.Status.Ephemeral",
                value: "Temporary notifications enabled",
                comment: ""
            )
    ...
    public var body: some View {
        List {
            Section {
                ...
                Text(
                    "Get gentle reminders for bedtime routines and sleep schedules. Notifications require parental approval."
                )
                .font(.caption)
            }
